...
python nasdip.py f16_512_rgb --sigma 25 --num_iter 1200 --save_out_at 1000,1100,1200 --check
...
# save_out_at: A list of integer to save the outputs at these iterations.
# check: If this flag is set, checks whether the output files are already exists.
python nasdip.py monar_256 --p 50 --num_iter 9500 --save_out_at 8500,8700,9000 --check
...
# save_out_at: A list of integer to save the outputs at these iterations.
# check: If this flag is set, checks whether the output files are already exists.
python nasdip.py woman_rgb --zoom 4 --num_iter 4500 --save_out_at 1000,1100,1200 --num_models 5000 --check


[1] https://yunchunchen.github.io/NAS-DIP/
